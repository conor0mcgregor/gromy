...
//
//  - Campo de búsqueda por nickname
//  - Botón para añadir
//  - Lista de miembros añadidos con ToggleSwitch para admin
// ─────────────────────────────────────────────────────────────────────────────
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        // ── Campo de búsqueda ──
        const FieldLabel(label: 'Añadir miembro por nickname'),
        const SizedBox(height: 8),
        Row(
          children: [
            Expanded(
        ...
        if (members.isNotEmpty) ...[
          Row(
            children: [
              const FieldLabel(label: 'Miembros añadidos'),
              const Spacer(),
              Text(
                '${members.length}',
                style: TextStyle(
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Busca por nickname y usa el toggle para marcar admins',
                      style: TextStyle(
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 4),
          Text(
            'Puedes añadirlos ahora o más tarde desde la gestión del equipo',
            style: TextStyle(
