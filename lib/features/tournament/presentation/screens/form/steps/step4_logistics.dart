...
/// Paso 4 — Logística y Privacidad: Máx. participantes, miembros por equipo
/// y tipo de visibilidad / acceso.
class Step4Logistics extends StatelessWidget {
  const Step4Logistics({
    super.key,
  ...
  Widget build(BuildContext context) {
    return StepCard(
      ...
      title: 'Logística y Privacidad',
      subtitle:
          'Define cuántos pueden apuntarse, el tamaño de los equipos y quién tiene acceso.',
      child: Column(
